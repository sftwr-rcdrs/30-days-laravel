<x-layouts.master>
    ...
    <section class="hero-section">
        ...
        <x-base-table-data :isPaginate="$categories instanceof \Illuminate\Pagination\LengthAwarePaginator" :table_headers="$table_headers" :extra_models="$extra_models" route_name="category" :items="$categories"
